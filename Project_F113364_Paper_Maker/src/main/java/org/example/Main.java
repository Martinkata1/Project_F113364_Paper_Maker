...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            //TODO
            System.out.println("7. Add printing shop");
            System.out.println("8. Select printing shop");
            System.out.println("9. Show me selected shop now");
            System.out.println("10. Add printing machine");
            System.out.println("11. Print the menu prices of paper types per piece.");
                ...
                switch (choice) {
                    ...
                    case 2:
                        ...
                        switch (edition.toLowerCase()) {
                            case "book": houses.get(selectedShopIndex).addEdition(new Book(title, copies, paper, price)); break;
                            case "poster": houses.get(selectedShopIndex).addEdition(new Poster(title, copies, paper, price)); break;
                            case "newspaper": houses.get(selectedShopIndex).addEdition(new Newspaper(title, copies, paper, price)); break;
                        }
                        break;
                    case 3:
                        if (selectedShopIndex == -1) {
